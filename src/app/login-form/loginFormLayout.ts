...
export class LoginFormLayoutComponent  {
    ...
    previewLoginMessage = 'Click continue to stop previewing as an anonymous user.';
    previewLoginButton = 'CONTINUE';
    loginFailedErrorMessage = 'Incorrect email or password entered. Please try again.';
    ...
    constructor(public authService: AuthService, private router: Router, private SDKRefreshService: RefreshService) {
        this.emailPlaceholder = (authService.isPreviewMode) ? '' : this.EMAIL_PLACEHOLDER;
    }
