...
} from './socialComponentRenderingContext';
 ...
 */
function isSocialComponentRenderingContext(aContext: RenderingContext): aContext is SocialComponentRenderingContext {
 ...
 */
function assertSocialComponentRenderingContext(aContext: RenderingContext): SocialComponentRenderingContext {
