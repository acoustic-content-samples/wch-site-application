 ...
 */
function isFormComponentRenderingContext(aContext: RenderingContext): aContext is FormComponentRenderingContext {
 ...
 */
function assertFormComponentRenderingContext(aContext: RenderingContext): FormComponentRenderingContext {
