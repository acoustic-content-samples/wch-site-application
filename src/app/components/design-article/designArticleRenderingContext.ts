...
import { DesignArticle, KEY_AUTHOR, KEY_AUTHOR_BIO, KEY_BODY, KEY_BODY_IMAGE, KEY_DATE, KEY_HEADING, KEY_MAIN_IMAGE, isDesignArticle } from './../../elements/design-article/designArticleType';
 ...
 */
export function isDesignArticleRenderingContext(aContext: RenderingContext): aContext is DesignArticleRenderingContext {
 ...
 */
export function assertDesignArticleRenderingContext(aContext: RenderingContext): DesignArticleRenderingContext {
 ...
 */
export const opDesignArticleRenderingContext: Generator<OperatorFunction<RenderingContext, DesignArticleRenderingContext>>  = () => map<RenderingContext, DesignArticleRenderingContext>(assertDesignArticleRenderingContext);