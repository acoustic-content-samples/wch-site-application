 ...
 */
function isContestRulesRenderingContext(aContext: RenderingContext): aContext is ContestRulesRenderingContext {
 ...
 */
function assertContestRulesRenderingContext(aContext: RenderingContext): ContestRulesRenderingContext {
