 ...
 */
import { Category, CategoryElement, GroupElement, Image, SingleImageElement, SingleTextElement, isCategoryElement, isMultiGroupElement, isSingleGroupElement, isSingleImageElement, isSingleTextElement } from '@ibm-wch-sdk/ng';
...
export interface SingleImageWithInformationElement extends ImageWithInformationElement {
    value: ImageWithInformation;
}

export interface MultiImageWithInformationElement extends ImageWithInformationElement {
...
*/
export function isImageWithInformation(aValue: any): aValue is ImageWithInformation {
    return !!aValue
        && isSingleImageElement(aValue[KEY_IMAGE])
        && isCategoryElement(aValue[KEY_IMAGE_SIZE])
        && (!aValue[KEY_IMAGE_PLACEMENT] || isCategoryElement(aValue[KEY_IMAGE_PLACEMENT]))
        && (!aValue[KEY_IMAGE_CAPTION] || isSingleTextElement(aValue[KEY_IMAGE_CAPTION]))
        && (!aValue[KEY_IMAGE_CREDIT] || isSingleTextElement(aValue[KEY_IMAGE_CREDIT]))
        ;
}
...
*/
export function isSingleImageWithInformationElement(aValue: any): aValue is SingleImageWithInformationElement {
...
*/
export function isMultiImageWithInformationElement(aValue: any): aValue is MultiImageWithInformationElement {
    return isMultiGroupElement(aValue) && aValue.values.every(isImageWithInformation);
}
