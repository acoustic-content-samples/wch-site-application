...
import { AllTypesPageHero4BlocksLayoutComponent } from './layouts/all-types-page-hero-4-blocks/all-types-page-hero-4-blocks';
import { FormComponentLayoutComponent } from './layouts/form-component/formComponentLayout';
...
import { AllTypesPageLayoutComponent } from './layouts/all-types-page/all-types-page';
...
import { SocialComponentLayoutComponent } from './layouts/social-component/socialComponentLayout';
...
export const LAYOUTS = [
  ...
  AllTypesPageHero4BlocksLayoutComponent,
  ...
  AllTypesPageHero2BlocksLayoutComponent
];