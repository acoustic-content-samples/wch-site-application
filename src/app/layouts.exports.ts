...
export { AllTypesPageHero4BlocksLayoutComponent } from './layouts/all-types-page-hero-4-blocks/all-types-page-hero-4-blocks';
...
export { AllTypesPageLayoutComponent } from './layouts/all-types-page/all-types-page';
...
export { SocialComponentLayoutComponent } from './layouts/social-component/socialComponentLayout';
