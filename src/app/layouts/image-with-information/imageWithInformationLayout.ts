 ...
 * @id image-with-information-layout
 */
@LayoutComponent({
    selector: 'image-with-information-layout'
})
@Component({
...
export class ImageWithInformationLayoutComponent extends TypeImageWithInformationComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.safeSubscribe(this.onRenderingContext, (renderingContext) => {
            ...
            this.imageSizeStr = this.utilsService.getFirstCategory(this.rContext, this.IMAGE_SIZE_KEY, 'medium', true);
            this.imagePlacementStr = this.utilsService.getFirstCategory(this.rContext, this.IMAGE_PLACEMENT_KEY, 'left', true);
        })
    }
