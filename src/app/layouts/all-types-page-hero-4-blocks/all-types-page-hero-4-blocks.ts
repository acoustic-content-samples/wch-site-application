...
/*
 * @name Five blocks
 * @id all-types-page-hero-4-blocks
 */
@LayoutComponent({
    selector: 'all-types-page-hero-4-blocks'
})
@Component({
  /**
  ...
  */
  ...
  selector: 'app-all-types-page-hero-4-blocks-layout-component',
  templateUrl: './all-types-page-hero-4-blocks.html',
  styleUrls: ['./all-types-page-hero-4-blocks.scss'],
  preserveWhitespaces: false
})
export class AllTypesPageHero4BlocksLayoutComponent extends TypeAllTypesPageComponent {
