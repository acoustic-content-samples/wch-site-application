...
export class FormComponentLayoutComponent extends TypeFormComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  submitForm(){
    if (this.nameValue && !this.emailValue) {
      ...
      this.dialogMessageBody = 'Name and email are required. Please enter them in the form';
      return false;
    }
    else if (!this.nameValue) {
      this.dialogMessageTitle = 'Error';
      this.dialogMessageBody = 'Name is required. Please enter it in the form';
      return false;
    }
    else if (!this.emailValue) {
      this.dialogMessageTitle = 'Error';
      this.dialogMessageBody = 'Email is required. Please enter it in the form';
      return false;
    }
    else {
