...
class SPASearchResults {
  ...
  constructor() {
    ...
    this.searchResultsPageLayout = this.heroPageLayout.$('wch-contentref app-search-results-layout-component');
    ...
    this.designPageArticleLayout = this.designPageLeftLayout.$('app-design-article-layout-component');
  ...
  waitUntilNot404Page() {
    return browser.wait(this.errorPage.isDisplayed().then(function(errorPage) {
      console.log("404 Error page is displayed");
      return false;
    }, function(error) {
      console.log("404 page not found");
